...
function addNewItem(rowData) {
    ...
    // // var rightGridData = rightGrid.data.serialize();
    // // // xóa hết dữ liệu hiện tại trong right 
    ...
    // //     var rightDataNew = [];
    // //     for (var index = 0; index < rightGridData.length; index++) {
    // //         var food_name_check = rightGridData[index].detail_food_name_add;
    // //         var count_check = rightGridData[index].detail_count_add;
            
    // //         console.log(`food_name_check: ${food_name_check}`)

    // //         if (rightDataNew.length == 0 ) {
    // //             rightDataNew.push({
    // //                 detail_food_name_add: food_name_check,
    // //                 detail_price_add: rightGridData[index].detail_price_add,
    // //                 detail_count_add: rightGridData[index].detail_count_add,
    // //                 detail_total_add: rightGridData[index].detail_total_add,
    // //                 detail_note_add: rightGridData[index].detail_note_add
    // //             });
    // //         } else {
    // //             rightDataNew.forEach(element => {
    // //                 console.log(`detail_food_name_add: ${element.detail_food_name_add}`)
                    
    // //                 if (food_name_check == element.detail_food_name_add ) {
    // //                     element.detail_count_add += count_check;
    // //                     element.detail_total_add = element.detail_count_add * element.detail_price_add;
    // //                 } else {
    // //                     rightDataNew.push({
    // //                         detail_food_name_add: food_name_check,
    // //                         detail_price_add: rightGridData[index].detail_price_add,
    ...
    // //     console.log(`new data: ${JSON.stringify(rightDataNew)}`);


    // //     // thêm lại dữ liệu right grid
    // //     rightDataNew.forEach(element => {
    // //         rightGrid.data.add({
    // //             detail_food_name_add: element.detail_food_name_add,
    // //             detail_price_add: element.detail_price_add,
    // //             detail_count_add: element.detail_count_add,
    // //             detail_total_add: element.detail_total_add,
    // //             detail_note_add: element.detail_note_add
    // //         });
    // //     });
