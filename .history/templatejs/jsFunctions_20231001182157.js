                                ...
                                align: "around", width: "900px", padding: "20px", cols: [
                                    {
                                        rows: [
                                            {
                                                type: "combo", name: "table_order_name", required: true, label: "Bàn", placeholder: "Chọn Bàn", listHeight: "100px", newOptions: true, labelWidth: "270px", padding: "10px", helpMessage: "Chọn bạn trong danh sách bàn trống",
                                                data: data.tableOptions
                                            },
                                            {
                                                type: "combo", name: "area_id", required: true, label: "Khu vực", placeholder: "Khu vực bàn được đặt", listHeight: "100px", newOptions: true, labelWidth: "270px", padding: "10px", helpMessage: "Bạn có thể thêm khu vực mới",
                                    ...
                                    },
                                    {
                                        rows: [
                                            {
                                                type: "combo", name: "promotion_description", label: "Khuyến mãi", placeholder: "Khuyến mãi", listHeight: "100px", labelWidth: "270px", labelWidth: "270px", padding: "10px", helpMessage: "Khuyến mãi được thêm vào từ chức năng Quản lý Khuyến mãi",
                                    ...
                                    {
                                        rows: [
                                            { labelWidth: "220px", type: "input", name: "total", required: true, label: "Tạm tính", placeholder: "Số tiền tạm tính", labelWidth: "270px", padding: "10px", readOnly: true },
