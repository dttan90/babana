                                ...
                                align: "around", width: "900px", padding: "20px", cols: [
                                    {
                                        rows: [
                                            ...
                                            {
                                                type: "combo", name: "area_name", required: true, label: "Khu vực", placeholder: "Khu vực bàn được đặt", listHeight: "100px", newOptions: true, labelWidth: "270px", padding: "10px",
