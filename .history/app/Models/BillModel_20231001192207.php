...
class BillModel extends Model
{
    ...
    protected $allowedFields = ['bill_id', 'date_check_in', 'date_check_out', 'total', 'status', 'table_id', 'promotion_id', 'note' ];
    protected $fields = 'bill_id, date_check_in, date_check_out, total, status, table_id, promotion_id, note';
