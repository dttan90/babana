...
class Home extends BaseController
{
        ...
        if (!empty($foodData)) {
            ...
            foreach ($foodData as $food) {
                ...
                $foodDataSet[] = array(
                    ...
                    'food_size_unit_code' => $food->size_unit_code . ':' . $size_unit_description ,
    ...
    public function saveOrder()
    {
        ...
        if ($request->is('post')) {
            ...
            if (!$result) {
                ...
                foreach ($gridData as $item) {
                    ...
                    $bill_detail_total = $item['detail_total_add'];
                    $size_unit_code = $item['detail_food_name_add'];
                    $food_id = $item['detail_food_name_add'];
                    $food_id = $item['detail_food_name_add'];
                    $food_id = $item['detail_food_name_add'];
                }
            }
        ...
        return json_encode(array('status' => 'true', 'name2' => $table_id), JSON_UNESCAPED_UNICODE);
    }
