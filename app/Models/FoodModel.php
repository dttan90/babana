...
class FoodModel extends Model
{
    ...
    protected $allowedFields = ['food_name', 'price', 'promotion_price', 'description', 'status', 'catalogy_id' ];
    protected $fields = 'food_name, price, promotion_price, description, status, catalogy_id';
